...
if [ "$type" == "0" ]; then
	...
	echo 11 > /sys/bus/i2c/devices/7-004e/tcpc/type_c_port0/pd_test
	sleep 1
	echo 10 > /sys/bus/i2c/devices/7-004e/tcpc/type_c_port0/pd_test
elif [ "$type" == "1" ]; then
	...
	echo 12 > /sys/bus/i2c/devices/7-004e/tcpc/type_c_port0/pd_test
else
